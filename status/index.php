...
$services[] = array("port" => "80",       "service" => "Web server",                  "ip" => "18.141.24.112") ;
$services[] = array("port" => "7777",       "service" => "Game Server",                     "ip" => "18.141.24.112") ;
$services[] = array("port" => "3306",     "service" => "MYSQL",                   "ip" => "127.0.0.1") ;
